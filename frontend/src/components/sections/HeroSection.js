...
// ✅ Preload critical images (add this to your index.html or _document.js)
// <link rel="preload" as="image" href="hero-bg.jpg" fetchpriority="high">

const HeroSection = ({ onScrollToBrands, brandsCount }) => (
  <section className="relative min-h-screen flex items-center overflow-hidden bg-slate-900">
    {/* ✅ FIXED: Background with proper dimensions and loading priority */}
    ...
    {/* ✅ FIXED: Simplified grid pattern (removed animation) */}
    ...
    {/* ✅ FIXED: Static ambient lighting (removed pulse animation) */}
    ...
    {/* ✅ REMOVED: Diagonal lines & floating particles (heavy animations) */}
...
const HeroContent = memo(({ onScrollToBrands, brandsCount }) => (
  <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-24 items-center">
    <div>
      {/* ✅ FIXED: Badge with min-height to prevent CLS */}
      <div className="inline-flex items-center gap-2 md:gap-3 lg:gap-4 mb-6 md:mb-8 lg:mb-12 group" style={{ minHeight: '40px' }}>
      ...
      {/* ✅ FIXED: Headlines with proper min-height to prevent CLS */}
      <div className="mb-4 md:mb-6 lg:mb-10" style={{ minHeight: '200px' }}>
      ...
      {/* ✅ FIXED: Features grid with proper structure */}
    ...
    {/* ✅ FIXED: Right side visual with proper image dimensions */}
    <div className="hidden lg:block relative">
      <div className="relative">
        ...
        {/* ✅ FIXED: Image with dimensions and lazy loading */}
        ...
        {/* ✅ FIXED: Floating card with fixed dimensions */}
        <div className="absolute -bottom-8 -left-8 bg-slate-800/95 backdrop-blur-xl border border-slate-700 p-8 group hover:border-blue-900 transition-all duration-300" style={{ minWidth: '280px', minHeight: '140px' }}>
...
// ✅ FIXED: Memoized feature item to prevent re-renders
...
// ✅ FIXED: Optimized buttons with passive event listeners
